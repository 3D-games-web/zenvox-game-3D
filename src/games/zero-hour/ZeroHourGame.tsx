...
function GameCanvas({
  ...
  return <div className="game-canvas" ref={mountRef} aria-label="NEXORA ZERO HOUR 3D arena" />;
}

export function ZeroHourGame() {
  ...
  return (
    <main className="game-shell">
      <header className="game-header">
        <a className="brand" href="#game" aria-label="NEXORA Zero Hour home"><span className="brand-mark" />NEXORA / ZERO HOUR</a>
        <p className="mission">Mission 01 <span>/</span> Secure the signal</p>
      ...
      <section className="game-stage" id="game">
        ...
        <div className="hud top-left"><span>Sector 07</span><b>Zero Hour arena</b></div>
